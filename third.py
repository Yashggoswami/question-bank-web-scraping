...
def find_data(count):
    for j in range(1, count+1):
        ...
        url = f"https://www.examveda.com/competitive-english/practice-mcq-question-on-grammar/?page={j}"
        # url = f"https://www.examveda.com/general-knowledge/practice-mcq-question-on-indian-railway/?page={j}"
        r = requests.get(url)
